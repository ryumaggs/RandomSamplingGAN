...
def recoding_survey_and_census_data(survey_df, census_df):
    ...
    if survey_df is not None:
        ...
        survey_df = survey_df[survey_df['RECVDVACC'] != -99]
        survey_df = survey_df[survey_df['RECVDVACC'] != -88]
        ...
        survey_df= survey_df[survey_df['MS'] != -99]
        survey_df= survey_df[survey_df['MS'] != -88]
        ...
        survey_df['RECVDVACC'] = survey_df['RECVDVACC'].apply(recode_recieved_vaccine)
        ...
        relevant_columns_local = ['RECVDVACC'] + relevant_columns_global
